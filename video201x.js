...
ControlBar.prototype.options_ = {
  children: ['playToggle', 'volumePanel', 'currentTimeDisplay', 'timeDivider', 'durationDisplay', 'progressControl', 'liveDisplay', 'remainingTimeDisplay', 'customControlSpacer', 'playbackRateMenuButton', 'chaptersButton', 'subsCapsButton', 'audioTrackButton', 'fullscreenToggle']
    //children: ['playToggle', 'volumePanel', 'currentTimeDisplay', 'timeDivider', 'durationDisplay', 'progressControl', 'liveDisplay', 'remainingTimeDisplay', 'customControlSpacer', 'playbackRateMenuButton', 'chaptersButton', 'descriptionsButton', 'subsCapsButton', 'audioTrackButton', 'fullscreenToggle']
    // 去除 'descriptionsButton',  由于源码问题，在移动端下这个组件报错
};
...
var Player = function (_Component) {
  ...
  Player.prototype.playbackRate = 20.0
  ...
  Player.prototype.defaultPlaybackRate = 20.0;
...
var parseCues = function parseCues(srcContent, track) {
  srcContent = 'WEBVTT FILE\r\n\r\n' + srcContent;
  srcContent = srcContent.replace(/(\d\d:\d\d:\d\d),(\d\d\d)/g, '$1.$2').replace(/(\d:\d\d:\d\d),(\d\d\d)/g, '$1.$2');
